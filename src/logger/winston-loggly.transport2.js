// https://github.com/loggly/winston-loggly-bulk/blob/3.x/lib/winston-loggly.js
/*
...
Loggly.prototype.log = function(level, msg, meta, callback) {
    ...
    return meta && meta.tags ? this.client.log(message, meta.tags, logged) : this.client.log(message, logged);
};
...
Loggly.prototype.extractContext = function(obj) {
    ...
    ["start", "from", "until", "order", "callback", "size", "format", "fields"].forEach(function(key) {
        if (obj[key]) {
            context[key] = obj[key];
            delete obj[key];
        }
